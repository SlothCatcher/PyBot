...
N_FEATURES = 594  # 76 moves(4*19) +4 faint/hp +14 status +8 hazards +4 switches +10 boosts +10 weather/field +1 speed +2 revealed +2 semi +2 sub +1 restr +22 volatiles +22 items +390 bench(2*5*39) +2 vuln +3 tera flags +19 tera_type +2 protect
