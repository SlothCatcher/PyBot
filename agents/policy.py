...
# N_FEATURES вырос 594 -> 629 -> 641 -> 653 -> 713 -> 715 -> 802 (+87 признаков урона).
# При 802 признаках первый слой (802->512) = 411k параметров, это 38% сети; +87 признаков
# добавили всего +4.3% параметров, сжатие первого слоя 802->512 = 1.57x (было 1.40x при 715).
